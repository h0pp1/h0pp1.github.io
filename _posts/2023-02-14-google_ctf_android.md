...
# Get Flag
***
아래와 같이 `Brute-force`하는 코드를 작성할 수 있습니다. 플레그의 포맷을 정확히 모르기 때문에 `strings.printable`를 이용하였는데 이게 100개이기 때문에 4글자를 돌릴려면 최악의 경우 1억번 확인을 해야합니다🥲 그 전에 나오긴 하겠지만 12글자를 확인해야하니 좀 오래걸릴 것 같습니다.  
<br/>
